          ...
          <Grid item xs={12} sm={6} md={4} key={drug.id}>
            <Card>
              ...
              <CardContent>
                ...
                <Typography variant="body2" sx={{ mt: 1 }}>
                  <strong>Pharmacy:</strong> {drug.pharmacy}
                </Typography>
                <Typography variant="body2" sx={{ mt: 1 }}>
                  <strong>Transaction ID:</strong> {drug.transactionId}
                </Typography>
...
export default DistributorDrugs;
